...
/**
 * Generates the listing of dependencies that is provided by the Bundle dependency of the current Bundle. This is
 * important as artifacts that bundle dependencies will
 * not project those dependences using the traditional maven dependency plugin. This plugin will override that setting
 * in order to print the dependencies being
 * inherited at runtime.
 */
@Mojo(name = "provided-bundle-dependencies",
...
public class BundleProvidedDependenciesMojo extends AbstractMojo {
   ...
   * supported format are: <code>tree</code>
   * or <code>pom</code>.
   */
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    try {
      ...
      final DependencyNode root = dependencyTreeBuilder
          .buildDependencyTree(bundleResult.getProject(), localRepository, null);
  ...
  /**
   * Creates a new ArtifactHandler for the specified Artifact that overrides the includeDependencies flag. When set,
   * this flag prevents transitive
